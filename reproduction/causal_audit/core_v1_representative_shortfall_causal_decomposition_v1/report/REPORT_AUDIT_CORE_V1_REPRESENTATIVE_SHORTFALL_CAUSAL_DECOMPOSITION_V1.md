...
## Protocol-named deliverables

The package contains separate F01–F11 evidence directories, a causal-attribution graph and interaction matrix, claim-boundary files, engineering/autonomy audits, and 28 protocol-named figures. These files only materialize the already frozen, reanalysed, shadow, bounded-oracle, counterfactual, and data-availability evidence classes; they are not additional formal method runs.
