...
def main()->int:
    ...
    lock={
      ...
      "attempt0":protocol["execution_attempt"]["attempt0"],"retry1":protocol["execution_attempt"]["retry1"],"attempt0_authority_files":ATTEMPT_FILES[ATTEMPT0_ROOT],"retry1_authority_files":ATTEMPT_FILES[RETRY1_ROOT],"retry_reason":protocol["execution_attempt"]["retry_reason"],
...
- Retry2 root: `{RESULT_ROOT}`; tmux: `{SESSION}`; token: `{TOKEN}`.
