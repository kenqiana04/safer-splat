...
def launch() -> None:
    ...
    write(root / LAUNCH_MARKER, {
        "schema": "POST_REPAIR_V3_BOUNDED_RECOVERY_RETRY3_LAUNCH_AUTHORIZATION_V1",
...
def main() -> int:
    ...
    parser.add_argument("--authorize-execution", choices=("EXECUTE_POST_REPAIR_V3_BOUNDED_RECOVERY_PAIRED_VALIDATION_V1_R3",))
    parser.add_argument("--launch-token", help=argparse.SUPPRESS)
    args = parser.parse_args()
    if args.launch:
        if args.authorize_execution != "EXECUTE_POST_REPAIR_V3_BOUNDED_RECOVERY_PAIRED_VALIDATION_V1_R3":
