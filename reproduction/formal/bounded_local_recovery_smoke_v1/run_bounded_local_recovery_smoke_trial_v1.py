...
AUTH_NAME = "BOUNDED_RECOVERY_INTERNAL_CHILD_AUTHORIZATION.json"
TOKEN_ENV = "SAFER_SPLAT_BOUNDED_RECOVERY_SMOKE_CHILD_TOKEN"
...
def load_delegate():
    ...
    def verify_source_and_map(checkout: Path, _projected: dict, require_execution_lock: bool = True):
        from validate_bounded_local_recovery_smoke_v1 import validate_freeze
...
def main() -> int:
    ...
    metadata = {
        "schema": "BOUNDED_RECOVERY_SMOKE_TRIAL_PROCESS_METADATA_V1", "trial_id": args.one,
