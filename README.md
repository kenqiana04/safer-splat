# This is the SplatBridge Repository Associated with SaferSplat.
Please note that this code is designed to work with the ModalAI Starling 2 drone. For general SplatBridge usage please see [here](https://github.com/javieryu/nerf_bridge).
...
To run the code
```
ns-train ros-depth-splatfacto --data configs/modal.json --pipeline.datamanager.num-training-images 300 --pipeline.datamanager.dataparser.scene-scale-factor 0.3 --pipeline.datamanager.data-update-freq 3.0
```
